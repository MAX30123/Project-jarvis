#Hi my name is Maxim, i created own jarvis using only python.I use pyttsx3 to tts and speech_recognition to stt.
#For open website or open application, i use wbbrowser and subprocess.this jarvis can open google, discord, youtube,steam and roblox.
#and jarvis can create project ".py"
